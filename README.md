...
[![Version](https://img.shields.io/badge/version-3.26.1-blue.svg)](CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/tests-331%2F331%20passing-brightgreen.svg)](tests/)
...
[![Cowork](https://img.shields.io/badge/cowork-team%20persistent-purple.svg)](#supported-surfaces-v3261)
...
Yes — verified-real native manifests ship for all 8 surfaces (CC, Cowork, Codex, Cursor, Copilot CLI, Antigravity, Hermes Agent, OpenClaw). See [Supported surfaces](#supported-surfaces-v3261) above for per-platform install commands.
