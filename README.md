...
[![Tests](https://img.shields.io/badge/tests-364%2F364%20passing-brightgreen.svg)](tests/)
...
[![Cowork](https://img.shields.io/badge/cowork-team%20persistent-purple.svg)](#supported-surfaces-v3290)
...
Yes — verified-real native manifests ship for all 8 surfaces (CC, Cowork, Codex, Cursor, Copilot CLI, Antigravity, Hermes Agent, OpenClaw). See [Supported surfaces](#supported-surfaces-v3290) above for per-platform install commands.
