...
[![Tests](https://img.shields.io/badge/tests-340%2F340%20passing-brightgreen.svg)](tests/)
...
[![Cowork](https://img.shields.io/badge/cowork-team%20persistent-purple.svg)](#supported-surfaces-v3270)
...
Yes — verified-real native manifests ship for all 8 surfaces (CC, Cowork, Codex, Cursor, Copilot CLI, Antigravity, Hermes Agent, OpenClaw). See [Supported surfaces](#supported-surfaces-v3270) above for per-platform install commands.
