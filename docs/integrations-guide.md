...
|---|---|
| Content creation (briefs, calendars, social posts, email sequences) | 163 skills + `platform-specs.md` (format specs for 15+ platforms) |
